  ...
  <div class="w-full">
    <form onsubmit={submit} class="flex flex-col gap-3">
      ...
      <div class="flex flex-col gap-y-4">
        <p class="text-sm text-gray-600">Do you consent to photos/videos of you and your child being taken during the Latch and Learn group and give Tiny Tides Therapy
