...
<div>
  ...
  <div class="flex items-center justify-between mt-4 px-2">
    ...
    <div class="w-16 flex flex-col items-center">
      ...
      <p class="text-xs text-center transition-all ease-in-out duration-300">
        {!completed ? 'Mark as Complete' : 'Complete'}
      </p>
    </div>
  </div>
</div>
