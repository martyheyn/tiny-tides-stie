...
<dialog
  ...
  on:close={closeModal}
  class="backdrop:bg-black/50 backdrop:backdrop-blur-sm bg-white w-93.75 sm:w-full max-w-2xl max-h-[80vh] md:max-h-[90vh] rounded-2xl shadow-2xl overflow-y-auto"
>
