...
<button
  class={lockBtn
    ? 'text-black opacity-50 hover:opacity-100 flex items-center gap-x-1.5 cursor-pointer hover:scale-103 transition-all duration-300 ease-in-out'
    : 'w-72 font-semibold text-xl px-6 py-3 bg-secondary hover:bg-[#90e8e8] text-text transition-all duration-300 ease-in-out cursor-pointer rounded-md hover:scale-102 shadow-lg hover:shadow-2xl'}
