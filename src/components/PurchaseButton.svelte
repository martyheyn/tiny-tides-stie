<script lang="ts">
  ...
  let { slug, modalId = 'signin-dialog', lockBtn = false }:
...
<button
  class={lockBtn ? 'text-black opacity-50 hover:opacity-100 flex items-center gap-x-[6px] cursor-pointer hover:scale-[1.03] transition-all duration-300 ease-in-out'
...
>
    {#if lockBtn}
        <svg class="w-5 h-5 mb-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
