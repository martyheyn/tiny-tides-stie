/* empty css                                 */
import { _ as __vite_glob_0_0 } from '../chunks/ages_CDiCmN9m.mjs';
import { _ as __vite_glob_0_1 } from '../chunks/evaluation_CyYcSmrk.mjs';
import { _ as __vite_glob_0_2 } from '../chunks/first_visit_JjrL9V0W.mjs';
import { _ as __vite_glob_0_3 } from '../chunks/insurance_CpSdujSS.mjs';
import { _ as __vite_glob_0_4 } from '../chunks/virtual_BttFviVH.mjs';
...
import { e as ensure_array_like } from '../chunks/_@astro-renderers_bPVGQiWf.mjs';
...
const $$Faqs = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "pageTitle": pageTitle, "description": description }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="w-full bg-primary pt-14 md:pt-[76px] min-h-screen flex justify-center"> <div class="flex flex-col max-w-2xl items-center justify-center my-8 px-4 transition-all duration-300 ease-in-out"> <h1 class="header-title mb-4 md:mb-8 text-center"> <span class="straight_underline z-10">FAQs</span> </h1> ${renderComponent($$result2, "Faq", Faq, { "client:load": true, "faqs": faqs, "client:component-hydration": "load", "client:component-path": "/Users/martyheyn/Documents/projects/tiny-tides/tiny-tides-site/src/components/Faq.svelte", "client:component-export": "default" })} </div> </div> ` })}`;
